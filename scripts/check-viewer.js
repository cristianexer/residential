async () => {
  ...
  check("Selected component inspector matches actual mesh",!document.querySelector("#inspector").hidden&&document.querySelector("#component-meta").textContent.includes(selectedHit.object.name));
  ...
  check("Restoring isolation restores control label",document.querySelector("#isolate-component").textContent==="Izolează");
  v.reset();
